...
namespace CompleteProject
{
    ...
    public class TestPurchaser : MonoBehaviour, IStoreListener
    {
        public Text DebugText;
        public Text NoAdsShopText;
        public Text TestText;
        private static IStoreController m_StoreController;                                                                  // Reference to the Purchasing system.
        private static IExtensionProvider m_StoreExtensionProvider;
        private List<ProductDescription> nonComsumables;
        ...
        private const string kProductIDNoAds = "no_ads";
        private const string kProductIdTest = "test";
        ...
        private static string kProduktNameGooleTest = "android.test.purchased";

        private void SetNoAdsButtonText(ProductMetadata meta)
        {
            NoAdsShopText.text += "\n";
            NoAdsShopText.text += meta.localizedPriceString;
        }
        void Start()
        {
        ...
        public void InitializePurchasing()
        {
            ...
            builder.AddProduct(kProductIdTest, ProductType.NonConsumable, new IDs() { { kProduktNameGooleTest, GooglePlay.Name }, });
            builder.AddProduct(kProductIDNoAds, ProductType.NonConsumable, new IDs() { { kProductNameGooglePlayNoAds, GooglePlay.Name }, });
        ...
        public void OnProductsRetrieved(List<ProductDescription> products)
        {
            ...
            DebugText.text += "OnProductsRetrieved: " + products.ToString();
        }
        ...
        void BuyProductID(string productId)
        {
            ...
            catch (Exception e)
            {
                ...
                DebugText.text = "\nBuyProductID: FAIL. Exception during purchase. " + e;
        ...
        public void OnInitialized(IStoreController controller, IExtensionProvider extensions)
        {
            ...
            DebugText.text += "\nHas receipt " + product.hasReceipt;
            DebugText.text += "\n" + product.metadata.localizedPriceString;
            NoAdsShopText.text += "\n" + product.metadata.localizedPriceString;


            product = m_StoreController.products.WithID(kProductIdTest);
            productMetadata = product.metadata;
            DebugText.text += "\n" + product.definition.id;
            DebugText.text += "\nHas receipt " + product.hasReceipt;
            DebugText.text += "\n" + product.metadata.localizedPriceString;
            if (product.hasReceipt) {
                TestText.text = "Bought!";
            }
            else
            {
                TestText.text = "Buy it for " + product.metadata.localizedPriceString;
            }
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            if (String.Equals(args.purchasedProduct.definition.id, kProductIdTest, StringComparison.Ordinal))
            {
                DebugText.text += "\n" + string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id);
